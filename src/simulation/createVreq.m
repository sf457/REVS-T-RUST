...
% 2) Build your Offtransaction with the usual counters *plus* that empty tx
    Vreqi.Offtransaction = struct('numTransactions', numTransactions, 'numSuccess', numSuccess, 'numFailed', numFailed);
