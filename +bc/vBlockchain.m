...
classdef vBlockchain < handle
    ...
    methods
        function obj = vBlockchain()
            obj.blockchain = bc.vBlockchain.genesis_block();
        end
...
% end
    ...
    methods (Static = true)
        ...
        function gen = genesis_block(Vreqipool)
    ...
    'description', 'Genesis block: initial system configuration' ...
);
           %data = Vreqi;
           %data=Vreqipool(1);
           %data=createVreqPool(30, 50, 2); 
%                        data.PID = 'Vreq1';
